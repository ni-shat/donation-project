...
export default function Header() {
    return (
        <div>
            ...
            <p className='2xl:text-[42px] xl:text-[42px] lg:text-[42px] md:text-4xl sm:text-2xl text-xl font-semibold 2xl:w-[85%]  w-full mx-auto text-center 2xl:leading-[1.1] xl:leading-[1.1] lg:leading-[1.1]'>Help us feed thousands of families who are struggling every day.</p>
